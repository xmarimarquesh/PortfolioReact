...
function Profissional() {
  ...
  function gerarDocumentoWord() {
    ...
    const blob = new Blob([conteudoHtml], { type: "Profissionallication/msword" });
  ...
  const handleZap = () => {
    const urlZAPZAP = `https://api.whatsapp.com/send?phone=5541988037571&text=Olá, Boa tarde! Vim através de seu portfólio.`
      ...
      <main id="apresentacao">
        ...
        <section className={style.apresentacao}>
          <div className={style.texto_apresentacao}>
            ...
            <div className={style.icons}>
              ...
              <img onClick={handleZap} src={whats} alt="whatsProfissional" />
        ...
        <section className={style.aboutme} id="sobremim">
            ...
            <div className={style.contato}>
                  ...
                  <a href='' onClick={handleZap} className={style.item_contato}><img src={whats_branco} alt="whatsProfissional"/><h2>(41) 9 9750-4019</h2></a>
        ...
        <footer className={style.footerProfissional}>Mariana Marques Hipolito - 16/09/2024</footer>
      </main>
    </div>
  );
}
